...
<script>
  ...
  onMount(() => {
    axios.get(`${api}/dataCenterLocations/${id}/dataCenterMachines`)
...
{/if}
<a class="btn" href={`/web-root-manager/data-centers/create-machine?dataCenterLocationId=${id}`}>ADD RECORD</a>
