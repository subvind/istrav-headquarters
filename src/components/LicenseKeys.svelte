...
<div class="white">
        ...
        <div class="chart">
          <div class="row" style="margin-bottom: 0;">
            <div class="col m4" style="text-align: center;">
              ...
              <a href="https://istrav.com/pricing" class="btn grey fluid" style="text-transform: none;">Learn More</a>
            </div>
            <div class="col m4" style="text-align: center;">
  ...
  <div style="text-align: center; width: 100%; margin-top: 250px;">
    <img src="/graphics/rocket.png" alt="" style="width: 150px; margin-left: -75px; position: absolute; bottom: 20px; z-index: 0" /><br />
  </div>
