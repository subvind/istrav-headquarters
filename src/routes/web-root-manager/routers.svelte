<script>
  ...
  import ModalCreate from "../../components/FloatingButtons/CreateRouters.svelte"
  ...
  let columns = [
    ...
    },
    {
      ...
      formatter: (cell, row) => {
        return h('button', {
          className: 'btn',
          onClick: () => window.location.href = `/web-root-manager/routers/${row.cells[0].data}/view-pfs`
        }, 'VIEW');
      }
    },
  ]
...
<div class="row" style="background: #555;">
  ...
  <div class="col s10">
    ...
    <p style="color: #eee;">These records represnt the firewall for your machines. </p>
    <ul class="tabs tabs-fixed-width">
      <li class="tab col s3"><a class="active" href="#test1">pfSense</a></li>
      <li class="tab col s3"><a class="active" href="#test2">RouterOS</a></li>
    </ul>
  </div>
</div>
