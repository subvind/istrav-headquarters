<script>
  ...
  import ModalCreate from "../../components/FloatingButtons/CreateClusters.svelte"
  ...
  let columns = [
    ...
    // },
    {
      ...
      formatter: (cell, row) => {
        return h('button', {
          className: 'btn',
          onClick: () => window.location.href = `/web-root-manager/clusters/${row.cells[0].data}/view-k8s`
        }, 'VIEW');
      }
    },
  ]
...
<div class="row" style="background: #555;">
  ...
  <div class="col s10">
    ...
    <ul class="tabs tabs-fixed-width">
      <li class="tab col s3"><a class="active" href="#test1">KUBERNETES</a></li>
      <li class="tab col s3"><a class="active" href="#test2">DOCKER SWARM</a></li>
    </ul>
  </div>
</div>
